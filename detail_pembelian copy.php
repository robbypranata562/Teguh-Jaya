...
$saldoo=$data['saldo'];
 	...
 	if ($kembali<0) {
          ...
          $sql_trans="INSERT INTO transaksi (id_pelanggan,tot_belanja,jumlah_bayar,Kembalian,faktur,hutang_pertgl) VALUES('$id_pelanggan','$total','$jum_bayar','$kembali','$kode_otomatis', '$tambahHutang')";
