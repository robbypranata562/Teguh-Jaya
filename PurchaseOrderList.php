    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <a href="PurchaseOrder.php"><h3 class="box-title"><span class="glyphicon glyphicon-plus"></span>Purchase Order</h3></a>
				...
				<?php
                    ...
                    while($data=mysqli_fetch_array($exe))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="pelanggan_ubah.php?id=<?php echo $data['Id'];?>">Detail</a></td>
